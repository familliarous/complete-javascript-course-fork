...
console.log(+'23'); // Auto-casts to number

// Parsing
console.log(Number.parseInt('30px')); // has to start with a number
console.log(Number.parseFloat('2.5rem')); // 2.5
console.log(Number.parseInt('2.5rem')); // 2

console.log(Number.isNaN('20'));
console.log(Number.isNaN(20));
console.log(Number.isNaN(+'20x')); // NaN (has x)
console.log(Number.isNaN(20 / 0)); // false (it doesn't check for Infinity)

// Checking if value is a number (isFinite is better)
